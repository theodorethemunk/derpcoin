(function() {
    ...
    function d() {
        o ? localStorage.setItem("theme", "light") : localStorage.setItem("theme", "dark"), e(), window.location.reload()
    }
    if (n ? (n.addEventListener("click", d, !1), window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", t => t.matches && e()), window.matchMedia("(prefers-color-scheme: light)").addEventListener("change", t => t.matches && e()), e()) : localStorage.removeItem("theme"), t && window.addEventListener("scroll", () => {
            window.scrollY > 10 ? t.classList.add("minimize") : t.classList.remove("minimize")
        }), a) {
        let t = 0,
            e = 0;
        r.addEventListener("mousedown", () => {
            document.body.classList.contains("armageddon") || (document.body.classList.add("armageddon"), setTimeout(() => {
            ...
            const {
                ...
                clientWidth: o,
                clientHeight: i
            } = document.documentElement, n = (o / 2 - a) * 30 / o, s = (i / 2 - r) * 10 / i;
            n > 1 ? (t = 1, e = 1) : n < -13 ? t = -13 : (t = n, e = n), n > 1 ? e = 1 : n < -9 ? e = -9 : e = n, c.style.transform = `translate(${-t}px, ${-s}px)`, l.style.transform = `translate(${-e}px, ${-s}px)`
        })
    }
})();
...
isMobileMenu(), menuTrigger && menuTrigger.addEventListener("click", () => menu && menu.classList.toggle("hidden")), window.addEventListener("resize", isMobileMenu), window.location.toString().includes("dogepedia") || (rect = document.querySelector("#home").getBoundingClientRect(), offset = {
    top: rect.top + window.scrollY,
    left: rect.left + window.scrollX
}, navbar = document.querySelector("header"), video = document.querySelector("#video-header"), window.onscroll = function() {
    window.pageYOffset > rect.height ? (navbar.classList.add("scrolled"), video.classList.add("scrolled")) : (navbar.classList.remove("scrolled"), video.classList.remove("scrolled"))
...
var rect, offset, navbar, video, _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function(t) {
            ...
            e = {
                ...
                util: {
                    ...
                    clone: function a(n, t) {
                        var s, o, i;
                        switch (t = t || {}, e.util.type(n)) {
                            case "Object":
                                if (o = e.util.objId(n), t[o]) return t[o];
                                for (i in s = {}, t[o] = s, n) n.hasOwnProperty(i) && (s[i] = a(n[i], t));
                                return s;
                            case "Array":
                                return o = e.util.objId(n), t[o] ? t[o] : (s = [], t[o] = s, n.forEach(function(e, n) {
                                    s[n] = a(e, t)
                                }), s);
                            default:
                                return n
                ...
                languages: {
                    extend: function(o, t) {
                        var n = e.util.clone(e.languages[o]),
                            s;
                        for (s in t) n[s] = t[s];
                        return n
                    },
                    insertBefore: function(i, c, s, o) {
                        var r = (o = o || e.languages)[i],
                            n = {},
                            t, a, l;
                        for (t in r)
                            if (r.hasOwnProperty(t)) {
                                if (t == c)
                                    for (a in s) s.hasOwnProperty(a) && (n[a] = s[a]);
                                s.hasOwnProperty(t) || (n[t] = r[t])
                            }
                        return l = o[i], o[i] = n, e.languages.DFS(e.languages, function(e, t) {
                            t === l && e != i && (this[e] = n)
                        }), n
                    },
                    DFS: function r(o, a, l, t) {
                        ...
                        for (s in o)
                            if (o.hasOwnProperty(s)) {
                                ...
                                var i, s, n = o[s],
                                    c = e.util.type(n);
                                "Object" !== c || t[i(n)] ? "Array" !== c || t[i(n)] || (t[i(n)] = !0, r(n, a, s, t)) : (t[i(n)] = !0, r(n, a, null, t))
                            }
                    }
                },
                plugins: {},
                ...
                highlightAllUnder: function(s, o, i) {
                    var t = {
                        ...
                        n, a;
                    e.hooks.run("before-highlightall", t), t.elements = Array.prototype.slice.apply(t.container.querySelectorAll(t.selector)), e.hooks.run("before-all-elements-highlight", t);
                    for (a = 0; n = t.elements[a++];) e.highlightElement(n, !0 === o, t.callback)
                },
                highlightElement: function(s, u, i) {
                    var a = e.util.getLanguage(s),
                        d = e.languages[a],
                        r, n, l;
                    s.className = s.className.replace(o, "").replace(/\s+/g, " ") + " language-" + a, r = s.parentElement, r && "pre" === r.nodeName.toLowerCase() && (r.className = r.className.replace(o, "").replace(/\s+/g, " ") + " language-" + a), n = {
                        element: s,
                        language: a,
                        grammar: d,
                        code: s.textContent
                    ...
                    function c(t) {
                        n.highlightedCode = t, e.hooks.run("before-insert", n), n.element.innerHTML = n.highlightedCode, e.hooks.run("after-highlight", n), e.hooks.run("complete", n), i && i.call(n.element)
                    }
                    if (e.hooks.run("before-sanity-check", n), !n.code) return e.hooks.run("complete", n), void(i && i.call(n.element));
                    e.hooks.run("before-highlight", n), n.grammar ? u && t.Worker ? (l = new Worker(e.filename), l.onmessage = function(e) {
                        c(e.data)
                ...
                highlight: function(s, o, i) {
                    ...
                    return e.hooks.run("before-tokenize", t), t.tokens = e.tokenize(t.code, t.grammar), e.hooks.run("after-tokenize", t), n.stringify(e.util.encode(t.tokens), t.language)
                },
                tokenize: function(a, s) {
                    ...
                    return t = new d, i(t, t.head, a),
                        function M(j, l, p, N, D, d) {
                            for (h in p)
                                if (p.hasOwnProperty(h) && p[h]) {
                                    m = p[h], m = Array.isArray(m) ? m : [m];
                                    for (g = 0; g < m.length; ++g) {
                                        if (d && d.cause == h + "," + g) return;
                                        var h, m, g, s = m[g],
                                            A = s.inside,
                                            S = !!s.lookbehind,
                                            C = !!s.greedy,
                                            z = s.alias,
                                            T, f, c, y, v, b, L;
                                        C && !s.pattern.global && (T = s.pattern.toString().match(/[imsuy]*$/)[0], s.pattern = RegExp(s.pattern.source, T + "g"));
                                        for (var k = s.pattern || s, t = N.next, o = D; t !== l.tail && !(d && o >= d.reach); o += t.value.length, t = t.next) {
                                            if (f = t.value, l.length > j.length) return;
                                            if (!(f instanceof n)) {
                                                if (y = 1, C) {
                                                    if (!(c = r(k, o, j, S))) break;
                                                    var _ = c.index,
                                                        F = c.index + c[0].length,
                                                        a = o;
                                                    for (a += t.value.length; a <= _;) t = t.next, a += t.value.length;
                                                    if (a -= t.value.length, o = a, t.value instanceof n) continue;
                                                    for (v = t; v !== l.tail && (a < F || "string" == typeof v.value); v = v.next) y++, a += v.value.length;
                                                    y--, f = j.slice(o, a), c.index -= o
                                                } else if (!(c = r(k, 0, f, S))) continue;
                                                var _ = c.index,
                                                    w = c[0],
                                                    x = f.slice(0, _),
                                                    E = f.slice(_ + w.length),
                                                    O = o + f.length;
                                                d && O > d.reach && (d.reach = O), b = t.prev, x && (b = i(l, b, x), o += x.length), u(l, b, y), L = new n(h, A ? e.tokenize(w, A) : w, z, w), t = i(l, b, L), E && i(l, t, E), 1 < y && M(j, l, p, t.prev, o, {
                                                    cause: h + "," + g,
                                                    reach: O
                                                })
                                            }
                        ...
                        function(t) {
                            for (var n = [], e = t.head.next; e !== t.tail;) n.push(e.value), e = e.next;
                            return n
                        }(t)
                },
                hooks: {
        ...
        function r(t, s, o, i) {
            ...
            var e = t.exec(o),
                n;
            return e && i && e[1] && (n = e[1].length, e.index += n, e[0] = e[0].slice(n)), e
        }
        ...
        function i(s, e, o) {
            ...
            return e.next = t, n.prev = t, s.length++, t
        }

        function u(s, t, o) {
            for (var e = t.next, n = 0; n < o && e !== s.tail; n++) e = e.next;
            (t.next = e).prev = t, s.length -= n
        }
        if (t.Prism = e, n.stringify = function i(n, o) {
                if ("string" == typeof n) return n;
                if (Array.isArray(n)) return a = "", n.forEach(function(e) {
                    a += i(e, o)
                }), a;
                var a, t = {
                        type: n.type,
                    ...
                    s = n.alias,
                    r, c;
                s && (Array.isArray(s) ? Array.prototype.push.apply(t.classes, s) : t.classes.push(s)), e.hooks.run("wrap", t), r = "";
                for (c in t.attributes) r += " " + c + '="' + (t.attributes[c] || "").replace(/"/g, "&quot;") + '"';
                return "<" + t.tag + ' class="' + t.classes.join(" ") + '"' + r + ">" + t.content + "</" + t.tag + ">"
            }, !t.document) return t.addEventListener && (e.disableWorkerMessageHandler || t.addEventListener("message", function(o) {
            var n = JSON.parse(o.data),
                s = n.language,
                i = n.code,
                a = n.immediateClose;
            t.postMessage(e.highlight(i, e.languages[s], s)), a && t.close()
        }, !1)), e;
        ...
        return (s && (e.filename = s.src, s.hasAttribute("data-manual") && (e.manual = !0)), !e.manual) && (c = document.readyState, "loading" === c || "interactive" === c && s && s.defer ? document.addEventListener("DOMContentLoaded", a) : window.requestAnimationFrame ? window.requestAnimationFrame(a) : window.setTimeout(a, 16)), e
    }(_self);
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
    ...
    e.languages.css = {
        ...
        function: /[-a-z0-9]+(?=\()/i,
        punctuation: /[(){};:,]/
    }, e.languages.css.atrule.inside.rest = e.languages.css, n = e.languages.markup, n && (n.tag.addInlined("style", "css"), e.languages.insertBefore("inside", "attr-value", {
        "style-attr": {
...
}), Prism.languages.markup && Prism.languages.markup.tag.addInlined("script", "javascript"), Prism.languages.js = Prism.languages.javascript, Prism.languages.ada = {
    comment: /--.*/,
    string: /"(?:""|[^"\r\f\n])*"/i,
    number: [{
    ...
    for (var i = ["comment", "function-name", "for-or-select", "assign-left", "string", "environment", "function", "keyword", "builtin", "boolean", "file-descriptor", "operator", "punctuation", "number"], a = n.variable[1].inside, s = 0; s < i.length; s++) a[i[s]] = e.languages.bash[i[s]];
...
}), delete Prism.languages.c.boolean, ! function(o) {
    function t(e, t) {
            ...
            value: function(n, s, a, o) {
                if (n.language === s) {
                    ...
                    n.code = n.code.replace(a, function(e) {
                        ...
                        for (var r, a = i.length; - 1 !== n.code.indexOf(r = t(s, a));) ++a;
                        return i[a] = e, r
                ...
                if (n.language === s && n.tokenStack) {
                    ...
                    ! function h(c) {
                        for (l = 0; l < c.length && !(o >= i.length); l++)
                            if (a = c[l], "string" == typeof a || a.content && "string" == typeof a.content) {
                                {
                                    var l, a, f = i[o],
                                        v = n.tokenStack[f],
                                    ...
                                    if (-1 < d) {
                                        ...
                                        var p = u.substring(0, d),
                                            ...
                                            r = [];
                                        p && r.push.apply(r, h([p])), r.push(b), g && r.push.apply(r, h([g])), "string" == typeof a ? c.splice.apply(c, [l, 1].concat(r)) : a.content = r
                                    }
                                }
                            } else a.content && h(a.content);
                        return c
                    }(n.tokens)
                }
            }
    ...
    class: {
        pattern: /(^|\s)(?:IN|CH|CS|HS)(?=\s|$)/, lookbehind: !0, alias: "keyword"
    },
    type: {
    ...
    punctuation: /[()]/
}, Prism.languages["dns-zone"] = Prism.languages["dns-zone-file"], Prism.languages.docker = {
    keyword: {
    ...
    punctuation: /---|\.\.\.|[:[\]{}\-,|>?]/
}, Prism.languages.dockerfile = Prism.languages.docker, Prism.languages.elixir = {
    comment: /#.*/m,
    regex: {
    ...
    if ("groovy" === e.language && "string" === e.type) {
        var t = e.content[0],
            n;
        "'" != t && (n = /([^\\])(?:\$(?:\{.*?\}|[\w.]+))/, "$" === t && (n = /([^$])(?:\$(?:\{.*?\}|[\w.]+))/), e.content = e.content.replace(/&lt;/g, "<").replace(/&amp;/g, "&"), e.content = Prism.highlight(e.content, {
            expression: {
                pattern: n,
                lookbehind: !0,
    ...
    for (var s = ["css", {
        ...
        }, "erb", "javascript", "less", "markdown", "ruby", "scss", "textile"], o = {}, n = 0, i = s.length, t; n < i; n++) t = s[n], t = "string" == typeof t ? {
        filter: t,
        language: t
    } : t, e.languages[t.language] && (o["filter-" + t.filter] = {
    ...
    punctuation: /[{}[\];(),.:]/
}, Prism.languages.hs = Prism.languages.haskell, ! function(s) {
    s.languages.http = {
        "request-line": {
    ...
    var n, i, a, e = s.languages,
        ...
        t, c;
    for (t in o) o[t] && (n = n || {}, c = r[t] ? (void 0, a = (i = t).replace(/^[a-z]+\//, ""), "(?:" + i + "|\\w+/(?:[\\w.-]+\\+)+" + a + "(?![+\\w.-]))") : t, n[t.replace(/\//g, "-")] = {
                ...
                ! function(a, i) {
                    ...
                    if (s)
                        if (t = s[o], t || (r = {
                            ...
                            }, t = (s = e.languages.insertBefore(a, "comment", r))[o]), t instanceof RegExp && (t = s[o] = {
                                pattern: t
                            }), Array.isArray(t))
                            for (n = 0, c = t.length; n < c; n++) t[n] instanceof RegExp && (t[n] = {
                                pattern: t[n]
                            }), i(t[n]);
                        else i(t)
                }(t, function(e) {
    ...
    for (var o = ["function", "function-variable", "method", "method-variable", "property-access"], s = 0, i, t, a; s < o.length; s++) i = o[s], t = e.languages.javascript[i], "RegExp" === e.util.type(t) && (t = e.languages.javascript[i] = {
        pattern: t
    }), a = t.inside || {}, (t.inside = a)["maybe-class-name"] = /^[A-Z][\s\S]*/
    ...
    t.lambda.inside.arguments = a, t.defun.inside.arguments = s.util.clone(a), t.defun.inside.arguments.inside.sublist = a, s.languages.lisp = t, s.languages.elisp = t, s.languages.emacs = t, s.languages["emacs-lisp"] = t
    ...
    operator: /-[->]?|\+\+?|!=?|<<?=?|>>?=?|==?|&&?|\|\|?|[~^%?*/@]/
}), delete Prism.languages.objectivec["class-name"], Prism.languages.objc = Prism.languages.objectivec, Prism.languages.perl = {
    comment: [{
    ...
    var e = Prism.languages.powershell = {
        ...
        t = e.string[0].inside;
    t.boolean = e.boolean, t.variable = e.variable, t.function.inside = e
}(), ! function(t) {
...
}(Prism), Prism.languages.purescript = Prism.languages.extend("haskell", {
    ...
    s = e.util.clone(e.languages.javascript), e.languages.jsx = e.languages.extend("markup", s), e.languages.jsx.tag.pattern = /<\/?(?:[\w.:-]+(?:\s+(?:[\w.:$-]+(?:=(?:"(?:\\[^]|[^\\"])*"|'(?:\\[^]|[^\\'])*'|[^\s{'">=]+|\{(?:\{(?:\{[^{}]*\}|[^{}])*\}|[^{}])+\}))?|\{\s*\.{3}\s*[a-z_$][\w$]*(?:\.[a-z_$][\w$]*)*\s*\}))*\s*\/?)?>/i, e.languages.jsx.tag.inside.tag.pattern = /^<\/?[^\s>/]*/i, e.languages.jsx.tag.inside["attr-value"].pattern = /=(?!\{)(?:"(?:\\[^]|[^\\"])*"|'(?:\\[^]|[^\\'])*'|[^\s'">]+)/i, e.languages.jsx.tag.inside.tag.inside["class-name"] = /^[A-Z]\w*(?:\.[A-Z]\w*)*$/, e.languages.insertBefore("inside", "attr-name", {
        spread: {
    ...
    var s, t = function(e) {
        ...
        n = function(a) {
            for (var o = [], i = 0, s, c, r; i < a.length; i++) s = a[i], c = !1, ("string" != typeof s && ("tag" === s.type && s.content[0] && "tag" === s.content[0].type ? "</" === s.content[0].content[0].content ? 0 < o.length && o[o.length - 1].tagName === t(s.content[0].content[1]) && o.pop() : "/>" === s.content[s.content.length - 1].content || o.push({
                tagName: t(s.content[0].content[1]),
                openedBraces: 0
            }) : 0 < o.length && "punctuation" === s.type && "{" === s.content ? o[o.length - 1].openedBraces++ : 0 < o.length && 0 < o[o.length - 1].openedBraces && "punctuation" === s.type && "}" === s.content ? o[o.length - 1].openedBraces-- : c = !0), (c || "string" == typeof s) && 0 < o.length && 0 === o[o.length - 1].openedBraces) && (r = t(s), i < a.length - 1 && ("string" == typeof a[i + 1] || "plain-text" === a[i + 1].type) && (r += t(a[i + 1]), a.splice(i + 1, 1)), 0 < i && ("string" == typeof a[i - 1] || "plain-text" === a[i - 1].type) && (r = t(a[i - 1]) + r, a.splice(i - 1, 1), i--), a[i] = new e.Token("plain-text", r, null, r)), s.content && "string" != typeof s.content && n(s.content)
        };
    e.hooks.add("after-tokenize", function(e) {
    ...
    var n = e.util.clone(e.languages.typescript),
        t;
    e.languages.tsx = e.languages.extend("jsx", n), t = e.languages.tsx.tag, t.pattern = RegExp("(^|[^\\w$]|(?=</))(?:" + t.pattern.source + ")", t.pattern.flags), t.lookbehind = !0
}(Prism), ! function(o) {
    var t = {
            pattern: /\\[\\(){}[\]^$+*?|.]/,
            alias: "escape"
    ...
    for (var e = "/\\*(?:[^*/]|\\*(?!/)|/(?!\\*)|<self>)*\\*/", n = 0; n < 2; n++) e = e.replace(/<self>/g, function() {
        return e
    });
...
}), Prism.languages.swift.string.inside.interpolation.inside.rest = Prism.languages.swift, ! function(t) {
    function e(e) {
    ...
    punctuation: /[{}().,:?]/
}, Prism.languages.vb = Prism.languages["visual-basic"], Prism.languages.vba = Prism.languages["visual-basic"], Prism.languages.wasm = {
    comment: [/\(;[\s\S]*?;\)/, {
        pattern: /;;.*/,
        greedy: !0
    }],
    ...
    t("csharp", s), t("fsharp", s), t("vbnet", o)
}(Prism), ! function(o) {
    var t = /[*&][^\s[\]{},]+/,
        n = /!(?:<[\w\-%#;/?:@&=+$,.!~*'()[\]]+>|(?:[a-zA-Z\d-]*!)?[\w\-%#;/?:@&=+$.~*'()]+)?/,
    ...
    if ("undefined" != typeof self && self.Prism && self.document && document.querySelector) {
        var n, c = function() {
                if (void 0 === n) {
                    ...
                    e.style.fontSize = "13px", e.style.lineHeight = "1.5", e.style.padding = "0", e.style.border = "0", e.innerHTML = "&nbsp;<br />&nbsp;", document.body.appendChild(e), n = 38 === e.offsetHeight, document.body.removeChild(e)
                }
                return n
            },
            o = !0,
        ...
        Prism.hooks.add("before-sanity-check", function(n) {
            var t = n.element.parentElement,
                o = t && t.getAttribute("data-line"),
                s;
            t && o && /pre/i.test(t.nodeName) && (s = 0, e(".line-highlight", t).forEach(function(e) {
                s += e.textContent.length, e.parentNode.removeChild(e)
            }), s && /^( \n)+$/.test(n.code.slice(-s)) && (n.code = n.code.slice(0, -s)))
        }), Prism.hooks.add("complete", function a(n) {
            var e = n.element.parentElement,
                o = e && e.getAttribute("data-line"),
                c, l;
            e && o && /pre/i.test(e.nodeName) && (clearTimeout(i), c = Prism.plugins.lineNumbers, l = n.plugins && n.plugins.lineNumbers, t(e, "line-numbers") && c && !l ? Prism.hooks.add("line-numbers", a) : (s(e, o)(), i = setTimeout(r, 1)))
    ...
    function t(t, e) {
        return e = " " + e + " ", -1 < (" " + t.className + " ").replace(/[\n\t]/g, " ").indexOf(e)
    }
    ...
    function s(n, u, j) {
        var b = (u = "string" == typeof u ? u : n.getAttribute("data-line")).replace(/\s+/g, "").split(",").filter(Boolean),
            v = +n.getAttribute("data-line-offset") || 0,
            g = (c() ? parseInt : parseFloat)(getComputedStyle(n).lineHeight),
            l = t(n, "line-numbers"),
            i = n.querySelector("code"),
            p = l ? n : i || n,
            s = [],
            m = i && p != i ? function(s, t) {
        ...
        if (b.forEach(function(i) {
                var c = i.split("-"),
                    t = +c[0],
                    o = +c[1] || t,
                    e = n.querySelector('.line-highlight[data-range="' + i + '"]') || document.createElement("div"),
                    a, r, d, u;
                (s.push(function() {
                    e.setAttribute("aria-hidden", "true"), e.setAttribute("data-range", i), e.className = (j || "") + " line-highlight"
                }), l && Prism.plugins.lineNumbers) ? (a = Prism.plugins.lineNumbers.getLine(n, t), r = Prism.plugins.lineNumbers.getLine(n, o), a && (d = a.offsetTop + m + "px", s.push(function() {
                    e.style.top = d
                })), r && (u = r.offsetTop - a.offsetTop + r.offsetHeight + "px", s.push(function() {
                    e.style.height = u
                }))) : s.push(function() {
                    e.setAttribute("data-start", String(t)), t < o && e.setAttribute("data-end", String(o)), e.style.top = (t - v - 1) * g + m + "px", e.textContent = new Array(o - t + 2).join(" \n")
                }), s.push(function() {
                    p.appendChild(e)
                })
            }), h = n.id, l && h) {
            ...
            }), y = parseInt(n.getAttribute("data-start") || "1"), e(".line-numbers-rows > span", n).forEach(function(e, t) {
                var n = t + y;
                e.onclick = function() {
                    var e = h + "." + n;
                    o = !1, location.hash = e, setTimeout(function() {
                        o = !0
                    }, 1)
                }
            }))
    ...
    function r() {
        if (t = location.hash.slice(1), e(".temporary.line-highlight").forEach(function(e) {
                e.parentNode.removeChild(e)
            }), i = (t.match(/\.([\d,-]+)$/) || [, ""])[1], i && !document.getElementById(t)) {
            var t, i, a = t.slice(0, t.lastIndexOf(".")),
                n = document.getElementById(a);
            n && (n.hasAttribute("data-line") || n.setAttribute("data-line", ""), s(n, i, "temporary ")(), o && document.querySelector(".temporary.line-highlight").scrollIntoView())
        }
    }
}(), ! function() {
    if ("undefined" != typeof self && self.Prism && self.document) {
            ...
            o = Prism.plugins.lineNumbers = {
                getLine: function(n, t) {
                    if ("PRE" === n.tagName && n.classList.contains(e))
                        if (o = n.querySelector(".line-numbers-rows"), o) {
                            var o, s = parseInt(n.getAttribute("data-start"), 10) || 1,
                                i = s + (o.children.length - 1),
                                a;
                            return t < s && (t = s), i < t && (t = i), a = t - s, o.children[a]
                        }
                },
                resize: function(e) {
                    t([e])
        ...
        window.addEventListener("resize", function() {
            o.assumeViewportIndependence && s === window.innerWidth || (s = window.innerWidth, t(Array.prototype.slice.call(document.querySelectorAll("pre." + e))))
        }), Prism.hooks.add("complete", function(o) {
            if (o.code)
                if (i = o.element, s = i.parentNode, s && /pre/i.test(s.nodeName) && !i.querySelector(".line-numbers-rows") && Prism.util.isActive(i, e)) {
                    i.classList.remove(e), s.classList.add(e);
                    var i, s, a, r = o.code.match(n),
                        c = r ? r.length + 1 : 1,
                        l = new Array(c + 1).join("<span></span>");
                    (a = document.createElement("span")).setAttribute("aria-hidden", "true"), a.className = "line-numbers-rows", a.innerHTML = l, s.hasAttribute("data-start") && (s.style.counterReset = "linenumber " + (parseInt(s.getAttribute("data-start"), 10) - 1)), o.element.appendChild(a), t([s]), Prism.hooks.run("line-numbers", o)
                }
    ...
    function t(e) {
        if (0 != (e = e.filter(function(t) {
            ...
            var t = e.map(function(t) {
                var s = t.querySelector("code"),
                    o = t.querySelector(".line-numbers-rows"),
                    e, i, a;
                if (s && o) return e = t.querySelector(".line-numbers-sizer"), i = s.textContent.split(n), e || ((e = document.createElement("span")).className = "line-numbers-sizer", s.appendChild(e)), e.innerHTML = "0", e.style.display = "block", a = e.getBoundingClientRect().height, e.innerHTML = "", {
                    element: t,
                    lines: i,
                    lineHeights: [],
                    oneLinerHeight: a,
            ...
            t.forEach(function(e) {
                var s = e.sizer,
                    ...
                    n = e.lineHeights,
                    o = e.oneLinerHeight;
                n[t.length - 1] = void 0, t.forEach(function(e, i) {
                    if (e && 1 < e.length) {
                ...
                for (var s = n.sizer, t = n.lineHeights, o = 0, e = 0; e < t.length; e++) void 0 === t[e] && (t[e] = s.children[o++].getBoundingClientRect().height)
            }), t.forEach(function(e) {
                var t = e.sizer,
    ...
    if ("undefined" != typeof self && self.Prism && self.document) {
        var t = [],
            ...
            n = function() {},
            s, o;
        Prism.plugins.toolbar = {}, s = Prism.plugins.toolbar.registerButton = function(s, n) {
            var o = "function" == typeof n ? n : function(t) {
                ...
                })) : "string" == typeof n.url ? (e = document.createElement("a")).href = n.url : e = document.createElement("span"), n.className && e.classList.add(n.className), e.textContent = n.text, e
            };
            ...
            if (s = i.element.parentNode, s && /pre/i.test(s.nodeName) && !s.parentNode.classList.contains("code-toolbar")) {
                o = document.createElement("div"), o.classList.add("code-toolbar"), s.parentNode.insertBefore(o, s), o.appendChild(s), a = document.createElement("div"), a.classList.add("toolbar");
                var s, o, a, r = t,
                    c = function(e) {
                        for (; e;) {
                ...
                c && (r = c.map(function(t) {
                    ...
                    var t = n(i),
                        e;
                    t && (e = document.createElement("div"), e.classList.add("toolbar-item"), e.appendChild(t), a.appendChild(e))
                }), o.appendChild(a)
            }
        }, s("label", function(o) {
            ...
            if (e && /pre/i.test(e.nodeName) && e.hasAttribute("data-label")) {
                ...
                return n ? t = n.content : (e.hasAttribute("data-url") ? (t = document.createElement("a")).href = e.getAttribute("data-url") : t = document.createElement("span"), t.textContent = s), t
            }
        ...
        if (Prism.plugins.toolbar) {
            ...
            Prism.plugins.toolbar.registerButton("show-language", function(n) {
                ...
                if (s && /pre/i.test(s.nodeName))
                    if (o = s.getAttribute("data-language") || e[n.language] || ((t = n.language) && (t.substring(0, 1).toUpperCase() + t.substring(1)).replace(/s(?=cript)/, "S")), o) return i = document.createElement("span"), i.textContent = o, i
            })
